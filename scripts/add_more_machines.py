...
# 4 more Hammer Strength Back machines (Total 18 Hammer Strength Back machines!)
  ...
  },
  {
    ...
    name: 플레이트 체스트 서포티드 T-바 로우,
    nameEn: Plate-Loaded T-Bar Row,
    category: back,
    categories: [back],
    equipment: machine,
    loadType: plate-loaded,
  ...
  },
  {
    ...
    name: MTS 듀얼 핀 프론트 풀다운,
    nameEn: MTS Front Pulldown,
    category: back,
    categories: [back],
    equipment: machine,
    loadType: pin-loaded,
  ...
  // 싸이벡스 & 뉴텍 & 아스널 & 파나타 추가 머신들
  {
    ...
    name: 플레이트 오버헤드 풀다운,
    nameEn: Plate-Loaded Overhead Pulldown,
    category: back,
    categories: [back],
    equipment: machine,
    loadType: plate-loaded,
  ...
  },
  {
    ...
    name: 리로디드 펜듈럼 스쿼트,
    nameEn: ReLoaded Pendulum Squat,
    category: legs,
    categories: [legs],
    equipment: machine,
    loadType: plate-loaded,
  ...
  },
  {
    ...
    name: 컨버징 인클라인 체스트 프레스,
    nameEn: Converging Incline Chest Press,
    category: chest,
    categories: [chest],
    equipment: machine,
    loadType: plate-loaded,
  ...
  },
  {
    ...
    name: 토크 인클라인 체스트 프레스,
    nameEn: Torque Incline Chest Press,
    category: chest,
    categories: [chest],
    equipment: machine,
    loadType: plate-loaded,
  ...
  },
  {
    ...
    name: 퓨어스트렝스 체스트 프레스,
    nameEn: Pure Strength Chest Press,
    category: chest,
    categories: [chest],
    equipment: machine,
    loadType: plate-loaded,
