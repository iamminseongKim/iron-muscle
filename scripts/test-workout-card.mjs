...
const muscles = summarizeWorkoutDay([{ date: '2026-09-13', durationSeconds: 60, exercises: [{ exerciseId: 'bench-press', sets: [{ completed: true, weight: 40, reps: 10 }] }, { exerciseId: 'barbell-squat', sets: [{ completed: false, weight: 40, reps: 10 }] }] }], '2026-09-13');
assert.ok(muscles.primaryMuscles.includes('chest'));
assert.ok(!muscles.primaryMuscles.includes('quads'));
