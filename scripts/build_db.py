...
chest = [
  {
    ...
    'tips': ['허리는 자연스러운 아치를 유지하세요.', '네거티브 시 2~3초간 천천히 통제하세요.'],
    'isPopular': True
  },
  {
    ...
    'tips': ['각도가 45도를 넘으면 어깨 전면 개입이 커집니다.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['디클라인 벤치에서 바벨을 아랫가슴 라인으로 내렸다가 밉니다.'],
    'tips': ['그립을 너무 좁게 잡지 마세요.']
  },
  {
    ...
    'instructions': ['덤벨을 가슴 옆에 두고 깊게 이완한 후 호를 그리며 모아 밀어 올립니다.'],
    'tips': ['덤벨끼리 부딪치지 않고 장력을 유지하세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['인클라인 벤치에서 덤벨을 쇄골 옆으로 내렸다가 윗가슴으로 밀어냅니다.'],
    'tips': ['어깨가 으쓱하지 않게 견갑을 하강 고정하세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['디클라인 벤치에서 가슴 하부 깊숙이 이완 후 밀어냅니다.'],
    'tips': ['시선은 위를 향하세요.']
  },
  {
    'id': 'dumbbell-fly',
    ...
    'instructions': ['팔꿈치를 살짝 굽힌 채 큰 나무를 껴안듯 가슴을 벌렸다가 모아줍니다.'],
    'tips': ['어깨 관절에 통증이 없는 선까지만 내리세요.']
  },
  {
    ...
    'instructions': ['30도 벤치에서 덤벨을 양옆 사선 위로 열었다가 상부 가슴으로 모읍니다.'],
    'tips': ['팔꿈치 각도를 일정하게 고정하세요.']
  },
  {
  ...
  },
  {
    ...
    'instructions': ['팔꿈치 안쪽으로 패드를 밀어 가슴 안쪽을 짭니다.'],
    'tips': ['어깨가 말리지 않게 흉곽을 세우세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['상체를 살짝 숙이고 아래 사선으로 손을 모읍니다.'],
    'tips': ['손끝이 아랫배 앞에서 마주치도록 모아주세요.']
  },
  {
    ...
    'instructions': ['도르래를 바닥에 두고 쇄골 높이로 손을 모아 올립니다.'],
    'tips': ['어깨가 솟지 않게 하강 고정하세요.']
  },
  {
    'id': 'dips-chest',
    'name': '체스트 딥스',
    ...
    'category': 'chest',
    'categories': ['chest', 'arms', 'shoulders'],
    ...
    'instructions': ['상체를 30도 숙이고 가슴을 늘려 내려갔다 밀어 올립니다.'],
    'tips': ['상체를 앞으로 숙여야 가슴에 부하가 실립니다.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['패드에 무릎을 올리고 상체를 숙여 가슴에 집중합니다.'],
    'tips': ['핀 무게가 무거울수록 쉬워집니다.']
  },
  {
    'id': 'push-up',
    'name': '푸시업 (팔굽혀펴기)',
    ...
    'instructions': ['몸을 일직선으로 유지하고 가슴이 바닥에 닿기 직전까지 내립니다.'],
    'tips': ['허리가 처지지 않도록 복근을 조이세요.']
  },
  {
    ...
    'instructions': ['바벨이 쇄골 바로 아래로 떨어지도록 벤치 위치를 맞춥니다.'],
    'tips': ['수직 궤적으로 밀어내세요.']
  },
  {
    ...
    'instructions': ['흉골 아래로 바벨을 내렸다가 밀어 올립니다.'],
    'tips': ['안전 스토퍼를 가슴 높이에 맞추세요.']
  },
  {
    ...
    'instructions': ['덤벨을 머리 뒤로 천천히 내렸다가 가슴 위로 끌어옵니다.'],
    'tips': ['팔꿈치를 살짝 굽힌 상태를 유지하세요.']
  }
]
exercises.extend(chest)
...
back = [
  {
    ...
    'tips': ['허리가 굽지 않도록 흉곽을 세우고 복압을 100% 채우세요.'],
    'isPopular': True
  },
  {
    ...
    'loadType': 'barbell',
    'movementPlane': 'hip-hinge',
    'primaryMuscles': ['hamstrings', 'erectors', 'glutes'],
    ...
    'tips': ['무릎을 과하게 굽히지 말고 고관절의 앞뒤 이동에 집중하세요.'],
    'isPopular': True
  },
  {
    'id': 'rack-pull',
    ...
    'loadType': 'barbell',
    'movementPlane': 'hip-hinge',
    'primaryMuscles': ['traps', 'erectors', 'lats'],
    'secondaryMuscles': ['glutes', 'forearms'],
    'description': '파워랙 무릎 높이에서 바벨을 뽑아 올려 등 상부와 기립근에 초고중량을 퍼붓습니다.',
    'instructions': ['무릎 바로 아래 랙 핀에서 바벨을 잡고 견갑을 뒤로 잠그며 강하게 락아웃합니다.'],
    'tips': ['등의 두께감 형성에 최고의 운동입니다.']
  },
  {
    ...
    'tips': ['반동을 쓰지 않고 상체 각도를 일정하게 고정하세요.'],
    'isPopular': True
  },
  {
    'id': 'pendlay-row',
    ...
    'instructions': ['상체를 바닥과 수평으로 숙이고 바닥에서 가슴 아랫단으로 폭발적으로 당깁니다.'],
    'tips': ['순수 파워를 키울 수 있습니다.']
  },
  {
    'id': 't-bar-row',
    'name': 'T-바 로우 (프리웨이트)',
    ...
    'instructions': ['다리 사이에 바벨을 둔 채 가슴을 펴고 배꼽 쪽으로 당깁니다.'],
    'tips': ['상체가 너무 일어서지 않도록 고관절을 접으세요.']
  },
  {
  ...
  },
  {
    ...
    'instructions': ['어깨너비 1.5배로 바를 잡고 가슴 윗부분으로 수직 견인합니다.'],
    'tips': ['팔꿈치를 주머니에 꽂는다는 느낌을 유지하세요.'],
    'isPopular': True
  },
  {
    'id': 'lat-pulldown-mag',
    ...
    'instructions': ['중립 맥그립을 손바닥으로 받치듯 잡고 명치 방향으로 당깁니다.'],
    'tips': ['스트랩 없이도 등의 깊은 곳까지 자극을 전달합니다.']
  },
  {
    ...
    'instructions': ['어깨너비로 언더핸드 그립을 잡고 아랫가슴으로 당깁니다.'],
    'tips': ['이두근 개입을 감안하여 광배근 수축에 집중하세요.']
  },
  {
    'id': 'seated-cable-row',
    ...
    'instructions': ['발판을 밀어 자리를 잡고 배꼽 쪽으로 V바를 당깁니다.'],
    'tips': ['이완 시 상체가 앞으로 과하게 딸려가지 않도록 하세요.'],
    'isPopular': True
  },
  {
    'id': 'pull-up',
    ...
    'instructions': ['어깨보다 넓게 잡고 가슴을 봉에 닿게 한다는 느낌으로 당겨 올라갑니다.'],
    'tips': ['반동 없이 통제된 템포로 수행하세요.'],
    'isPopular': True
  },
  {
    'id': 'chin-up',
    ...
    'instructions': ['손바닥이 얼굴을 보게 잡고 턱이 바 위로 넘어갈 때까지 당깁니다.'],
    'tips': ['풀업보다 더 깊은 수축 범위를 가져갈 수 있습니다.']
  },
  {
    ...
    'movementPlane': 'vertical-pull',
    'primaryMuscles': ['lats'],
    'secondaryMuscles': ['triceps', 'deltoid_rear'],
    'description': '이두근 개입을 배제하고 광배근만을 단독 고립시키는 최고의 단관절 운동입니다.',
    'instructions': ['상체를 30도 숙이고 호를 그리며 바를 허벅지 앞쪽으로 눌러 당깁니다.'],
    'tips': ['광배근을 날개처럼 펼쳤다가 조여주세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['팔꿈치를 패드에 올리고 허벅지 앞까지 눌러 내립니다.'],
    'tips': ['손아귀 힘이 빠져도 팔꿈치로 광배근을 털 수 있습니다.']
  },
  {
    ...
    'movementPlane': 'horizontal-row',
    'primaryMuscles': ['lats'],
    'secondaryMuscles': ['traps', 'biceps', 'deltoid_rear'],
    'description': '한 손씩 진행하여 광배근을 바닥 끝까지 늘리고 골반까지 깊게 쥐어짭니다.',
    'instructions': ['한쪽 무릎을 벤치에 대고 반대 손으로 덤벨을 골반 쪽으로 당깁니다.'],
    'tips': ['몸통을 과도하게 비틀지 마세요.']
  },
  {
    'id': 'back-extension',
    'name': '백 익스텐션 (하이퍼익스텐션)',
    ...
    'instructions': ['골반을 패드에 대고 상체를 숙였다가 기립근 힘으로 일직선까지 듭니다.'],
    'tips': ['허리를 뒤로 과도하게 꺾지 마세요.']
  },
  {
    'id': 'good-morning',
    'name': '바벨 굿모닝',
    ...
    'loadType': 'barbell',
    'movementPlane': 'hip-hinge',
    'primaryMuscles': ['erectors', 'hamstrings', 'glutes'],
    'secondaryMuscles': ['traps'],
    'description': '바벨을 승모근에 얹고 인사하듯 상체를 숙여 후면 사슬 전체의 장력을 극대화합니다.',
    'instructions': ['등을 곧게 펴고 고관절을 뒤로 빼며 상체를 숙였다 돌아옵니다.'],
    'tips': ['무게 욕심을 버리고 정밀한 힙힌지 궤적에 집중하세요.']
  }
]
exercises.extend(back)
...
legs = [
  {
    ...
    'secondaryMuscles': ['hamstrings', 'erectors', 'calves'],
  ...
  },
  {
    ...
    'secondaryMuscles': ['glutes', 'abs', 'erectors'],
    'description': '바벨을 쇄골 앞쪽에 얹고 상체를 수직으로 세워 대퇴사두근 앞쪽을 집중 폭격합니다.',
    'instructions': ['팔꿈치를 높게 들고 상체를 꼿꼿이 세운 채 깊게 앉았다 일어납니다.'],
    'tips': ['허리 부담이 백스쿼트보다 적습니다.']
  },
  {
    'id': 'sumo-deadlift',
    'name': '스모 데드리프트',
    ...
    'secondaryMuscles': ['erectors', 'hamstrings', 'traps'],
    'description': '넓은 보폭으로 고관절 내전근과 둔근에 부하를 집중시키고 상체 각도를 더 세워 진행합니다.',
    'instructions': ['넓은 스탠스로 서서 무릎을 발끝 방향으로 열며 바를 잡고 지면을 찢듯이 밉니다.'],
    'tips': ['정강이가 바닥과 수직에 가깝게 유지되도록 스탠스를 조절하세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['무릎 각도를 살짝 굽힌 채 고정하고 상체를 수평 가까이 숙였다 올라옵니다.'],
    'tips': ['허리가 말리지 않는 유연성 범위까지만 내리세요.']
  },
  {
    ...
    'loadType': 'barbell',
    'movementPlane': 'hip-hinge',
    'primaryMuscles': ['quads', 'glutes', 'erectors'],
    'secondaryMuscles': ['traps', 'lats'],
    'description': '중립 손잡이로 척추 전단력을 최소화하며 안전하게 고중량을 들어올립니다.',
    'instructions': ['트랩바 중앙에 서서 양쪽 손잡이를 잡고 지면을 강하게 밀어냅니다.'],
    'tips': ['허리 부담이 있는 분들에게 최적입니다.']
  },
  {
    'id': 'leg-press-45',
    'name': '파워 레그프레스 (45도)',
    'nameEn': '45-Degree Plate-Loaded Leg Press',
    'category': 'legs',
    'categories': ['legs'],
    'equipment': 'machine',
    'loadType': 'plate-loaded',
    ...
    'instructions': ['발판 중앙에 발을 두고 무릎이 가슴 옆으로 올 때까지 내렸다가 밉니다.'],
    'tips': ['무릎을 완전히 펴서 관절을 잠그지 마세요.'],
    'isPopular': True
  },
  {
  ...
  },
  {
    ...
    'instructions': ['벨트를 착용하고 풀스쿼트로 앉았다 일어납니다.'],
    'tips': ['허리 디스크가 있어도 안전하게 하체를 털 수 있습니다.']
  },
  {
    ...
    'instructions': ['발목 패드를 밀어 다리를 수평까지 들어 올립니다.'],
    'tips': ['정점에서 1~2초간 쥐어짜세요.'],
    'isPopular': True
  },
  {
  ...
  },
  {
    ...
    'instructions': ['허벅지 패드를 누르고 발목 패드를 엉덩이 아래로 강하게 접어 내립니다.'],
    'tips': ['신장성 수축 시 천천히 버티며 올리세요.'],
    'isPopular': True
  },
  {
    'id': 'lying-leg-curl',
    ...
    'instructions': ['패드에 엎드려 엉덩이 쪽으로 발을 접어 올립니다.'],
    'tips': ['골반이 들썩이지 않도록 복압을 잡으세요.']
  },
  {
    ...
    'instructions': ['벤치에 등을 대고 골반에 바벨을 얹은 뒤 천장으로 높게 들어 올립니다.'],
    'tips': ['골반을 후방 경사시키며 둔근으로 수축하세요.'],
    'isPopular': True
  },
  {
    'id': 'hip-thrust-machine',
    'name': '플레이트 힙 쓰러스트 머신 (부티 빌더)',
    'nameEn': 'Plate-Loaded Hip Thrust Machine',
    'category': 'legs',
    'categories': ['legs'],
    'equipment': 'machine',
    'loadType': 'plate-loaded',
    ...
    'instructions': ['벨트를 채우고 발바닥으로 지면을 밀어 골반을 들어 올립니다.'],
    'tips': ['정점에서 둔근을 강하게 쥐어짜세요.']
  },
  {
    ...
    'instructions': ['패드를 무릎 바깥에 대고 다리를 양옆으로 힘차게 벌립니다.'],
    'tips': ['상체를 살짝 앞으로 숙이면 둔근 상부에 더 강한 자극이 옵니다.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['패드를 무릎 안쪽에 대고 다리를 안쪽으로 강하게 모아줍니다.'],
    'tips': ['이완 시 가동 범위를 무리하게 넓히지 마세요.']
  },
  {
    'id': 'walking-lunge',
    'name': '덤벨 워킹 런지',
    ...
    'instructions': ['덤벨을 들고 크게 내딛으며 뒷무릎이 바닥에 닿기 직전까지 앉습니다.'],
    'tips': ['앞발 뒤꿈치로 지면을 밀며 전진하세요.']
  },
  {
    ...
    'instructions': ['뒷발을 벤치에 얹고 앞다리로 깊게 스쿼트하듯 앉았다가 일어납니다.'],
    'tips': ['상체를 살짝 숙이면 둔근에 집중됩니다.']
  },
  {
    ...
    'instructions': ['발끝으로 블록을 디디고 뒤꿈치를 깊게 내렸다가 까치발로 높게 솟아오릅니다.'],
    'tips': ['정점에서 1초간 정지하세요.']
  },
  {
    ...
    'instructions': ['무릎 패드를 누르고 발목 가동 범위를 끝까지 활용하여 오르내립니다.'],
    'tips': ['발목 안정성에 필수적입니다.']
  }
]
exercises.extend(legs)
...
sac = [
  # =================== 어깨 (SHOULDERS) ===================
  {
    ...
    'category': 'shoulders',
    'categories': ['shoulders', 'arms', 'core'],
    'equipment': 'barbell',
    'loadType': 'barbell',
    'movementPlane': 'overhead-press',
    'primaryMuscles': ['deltoid_front'],
    'secondaryMuscles': ['deltoid_side', 'triceps', 'traps', 'abs'],
    'description': '서서 바벨을 머리 위로 밀어올려 전면 삼각근과 상체 전체의 스트렝스를 구축하는 3대급 운동입니다.',
    'instructions': ['쇄골 위에 바벨을 얹고 정수리 위로 수직으로 밀어 올립니다.'],
    'tips': ['허리가 뒤로 젖혀지지 않도록 엉덩이에 힘을 꽉 주세요.'],
    'isPopular': True
  },
  {
    ...
    'movementPlane': 'overhead-press',
    'primaryMuscles': ['deltoid_front'],
    'secondaryMuscles': ['deltoid_side', 'triceps'],
    'description': '덤벨의 자유로운 회전으로 어깨 충돌 없이 전면과 측면 삼각근을 꽉 채웁니다.',
    'instructions': ['직각 벤치에 앉아 귀 옆에서 머리 위로 호를 그리며 밀어 올립니다.'],
    'tips': ['팔꿈치를 살짝 앞으로 두세요.'],
    'isPopular': True
  },
  {
    'id': 'arnold-press',
    ...
    'instructions': ['손바닥이 얼굴을 보게 쥐고 회전시키며 위로 밀어 올립니다.'],
    'tips': ['부드러운 회전 리듬을 유지하세요.']
  },
  {
  ...
  },
  {
    ...
    'instructions': ['양옆으로 물을 따르듯 어깨 높이까지 들어 올립니다.'],
    'tips': ['어깨 뽕으로만 들어 올린다는 느낌을 유지하세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['도르래를 바닥에 두고 대각선 옆으로 들어 올립니다.'],
    'tips': ['몸통 뒤로 케이블을 통과시키면 더 깊은 수축이 가능합니다.']
  },
  {
    ...
    'instructions': ['팔꿈치를 패드에 대고 날개를 펴듯 밀어 올립니다.'],
    'tips': ['손목 힘이 약한 분들에게 최적입니다.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['가슴 패드에 상체를 대고 양옆 뒤쪽으로 넓게 벌려줍니다.'],
    'tips': ['어깨 뒤쪽 근육으로만 벌리세요.'],
    'isPopular': True
  },
  {
    'id': 'face-pull',
    ...
    'instructions': ['눈높이 케이블에서 로프를 이마 쪽으로 당깁니다.'],
    'tips': ['당기면서 외회전을 함께 만들어주세요.'],
    'isPopular': True
  },
  {
    'id': 'barbell-shrug',
    ...
    'instructions': ['어깨를 귀에 닿게 한다는 느낌으로 수직으로 끌어올립니다.'],
    'tips': ['수직으로만 오르내리세요.']
  },
  ...
  # =================== 팔 (ARMS) ===================
  {
    ...
    'instructions': ['팔꿈치를 옆구리에 고정한 채 가슴 쪽으로 감아 올립니다.'],
    'tips': ['치팅을 자제하세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['겨드랑이를 패드에 밀착시키고 이두근의 장력으로 말아 올립니다.'],
    'tips': ['팔꿈치 과신전에 주의하세요.']
  },
  {
    ...
    'instructions': ['인클라인 벤치에 기대어 덤벨을 감아 올립니다.'],
    'tips': ['팔꿈치를 앞으로 당겨오지 마세요.']
  },
  {
    ...
    'instructions': ['손바닥이 마주보게 덤벨을 쥐고 어깨 쪽으로 들어 올립니다.'],
    'tips': ['팔의 두께감 형성에 최고의 운동입니다.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['팔꿈치를 옆구리에 박아두고 로프를 바닥으로 내린 뒤 양옆으로 벌려줍니다.'],
    'tips': ['팔꿈치를 흔들리지 않게 고정하세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['상체를 살짝 숙인 채 수직 아래로 팔을 완전히 폅니다.'],
    'tips': ['손목이 꺾이지 않게 주의하세요.']
  },
  {
    'id': 'skull-crusher',
    ...
    'instructions': ['EZ바를 이마 뒤쪽으로 천천히 내렸다가 삼두 힘으로 폅니다.'],
    'tips': ['팔꿈치가 바깥으로 너무 벌어지지 않게 모아주세요.'],
    'isPopular': True
  },
  {
    ...
    'movementPlane': 'flat-press',
    'primaryMuscles': ['triceps'],
    'secondaryMuscles': ['chest', 'deltoid_front'],
    'description': '좁은 그립으로 벤치프레스를 수행하여 삼두근에 초고중량을 꽂아넣습니다.',
    'instructions': ['어깨너비 정도로 바벨을 좁게 잡고 팔꿈치를 몸통에 붙이며 밉니다.'],
    'tips': ['너무 좁게(20cm 미만) 잡지 마세요.']
  },
  {
    ...
    'instructions': ['등 뒤에서 케이블 로프를 잡고 머리 앞쪽으로 팔을 뻗어줍니다.'],
    'tips': ['팔꿈치 위치를 고정하세요.']
  },
  ...
  # =================== 복근 및 코어 (CORE) ===================
  {
    ...
    'instructions': ['철봉에 매달려 골반을 말아올리며 다리를 90도 이상 듭니다.'],
    'tips': ['골반을 가슴 쪽으로 말아올리는 것이 핵심입니다.'],
    'isPopular': True
  },
  {
    'id': 'cable-crunch',
    ...
    'instructions': ['무릎을 꿇고 로프를 귀 옆에 둔 채 등을 둥글게 말아 팔꿈치를 무릎에 붙입니다.'],
    'tips': ['복근으로만 수축하세요.'],
    'isPopular': True
  },
  {
    ...
    'instructions': ['패드를 가슴에 대고 복근을 쥐어짜며 상체를 웅크립니다.'],
    'tips': ['배로 당기세요.']
  },
  {
    'id': 'plank',
    ...
    'movementPlane': 'core',
    'primaryMuscles': ['abs'],
    'secondaryMuscles': ['glutes', 'deltoid_front'],
    'description': '코어의 심부 근육과 전신 안정성을 기르는 정적 버티기 운동입니다.',
    'instructions': ['머리부터 뒤꿈치까지 완벽한 일직선을 유지하며 버팁니다.'],
    'tips': ['엉덩이가 위로 솟지 않게 하세요.']
  },
  {
    'id': 'ab-roller',
    'name': 'AB 롤아웃 (AB 슬라이드)',
    ...
    'instructions': ['롤러를 앞으로 굴려 몸을 최대한 편 뒤 복근 힘으로 당겨옵니다.'],
    'tips': ['허리가 꺾이지 않도록 주의하세요.']
  }
]
exercises.extend(sac)
