...
> **문서 상태**: v4.0.0 연결 MVP 구현. 아래 원안 중 미구현 항목은 후속 기획이며 제품의 보장 사항이 아닙니다.
> **대상 플랫폼**: iOS (Apple HealthKit), Android (Health Connect)
> **철학**: 로컬 퍼스트, 앱 자체 외부 건강 데이터 서버 없음

## v4.0.0 구현 결정 (원안보다 우선)
...
- 현재 Capacitor 5에 맞는 로컬 네이티브 플러그인을 사용합니다. Android 공식 Health Connect 1.1.0의 최소 SDK 요구사항으로 Android 5.1~7.x 지원이 종료되어 **SemVer major인 4.0.0**을 선택했습니다. 앱 최소 Android 8, 연결 기능 Android 9 이상입니다. iOS 최소 13은 유지합니다.
