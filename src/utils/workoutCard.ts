...
export const WORKOUT_QUOTE_CATALOG: { text: string; author?: string; source?: string }[] = [
  ...
  { text: "다음의 나에게 남기는 응원." },
  { text: "Light weight baby!", author: "로니 콜먼", source: "https://ronniecoleman.net/pages/youtube-2" },
  { text: "Yeah buddy!", author: "로니 콜먼", source: "https://ronniecoleman.net/pages/youtube-2" },
  { text: "Ain't nothing to it but to do it!", author: "로니 콜먼", source: "https://ronniecoleman.net/pages/youtube-2" },
  { text: "When you think you're done, you're only halfway.", author: "톰 플라츠", source: "https://www.tomplatz.com" },
  { text: "Never give up.", author: "톰 플라츠", source: "https://www.tomplatz.com" },
  { text: "Failure is not an option.", author: "톰 플라츠", source: "https://www.tomplatz.com" },
  { text: "가슴은 가슴으로.", author: "강경원", source: "https://www.youtube.com/@KangKyungWon" },
  { text: "운동은 타협하는 순간 끝납니다.", author: "강경원", source: "https://www.youtube.com/@KangKyungWon" },
  { text: "올라잇 (All right)!", author: "박재훈", source: "https://www.youtube.com/@jaehun_park" },
  { text: "포기하지 마라, 올라잇!", author: "박재훈", source: "https://www.youtube.com/@jaehun_park" },
  { text: "No pain, no gain.", author: "아놀드 슈왈제네거", source: "https://www.schwarzenegger.com" },
  { text: "The last 3 or 4 reps is what makes muscles grow.", author: "아놀드 슈왈제네거", source: "https://www.schwarzenegger.com" },
  { text: "Blood and Guts.", author: "도리안 예이츠", source: "https://dorianyatesnutrition.com" },
  { text: "보디빌딩은 거짓말을 하지 않는다.", author: "김준호", source: "https://www.youtube.com/@ifbbprokimjunho" },
  { text: "드가자!", author: "장성엽", source: "https://www.youtube.com/@TheMouth_Jang" },
 ];
