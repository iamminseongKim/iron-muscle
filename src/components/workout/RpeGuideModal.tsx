...
export const RpeGuideModal: React.FC<RpeGuideModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
      <div className="bg-[#141721] border border-gray-700/80 rounded-2xl w-full max-w-md max-h-[85vh] overflow-hidden flex flex-col shadow-2xl">
        {/* Modal Header */}
        <div className="p-4 border-b border-gray-800 flex items-center justify-between bg-gradient-to-r from-gray-900 to-[#141721]">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-bold text-base text-white">RPE & RIR 가이드</h3>
        ...
        <div className="p-4 overflow-y-auto space-y-3.5 text-sm">
          <div className="bg-gradient-to-r from-red-950/40 to-amber-950/30 p-3.5 rounded-xl border border-red-800/40 text-xs text-gray-300 leading-relaxed">
            <strong className="text-red-300 font-bold block mb-1">💡 RPE란 무엇인가요?</strong>
          ...
          <div className="space-y-2.5">
            {rpeLevels.map((item, idx) => {
              ...
              return (
                <div key={idx} className="p-3 bg-[#1A1E2C] rounded-xl border border-gray-800/80 hover:border-gray-700 transition">
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <span className="text-[11px] font-semibold text-gray-400 bg-gray-900/60 px-2 py-0.5 rounded">
                      {item.rir}
                    </span>
                  </div>
        ...
        {/* Modal Footer */}
        <div className="p-3.5 border-t border-gray-800 bg-[#10131B] text-center">
          <button
            onClick={onClose}
            className="w-full py-2.5 bg-gradient-to-r from-[#FF334B] to-[#FF5C6F] text-white font-bold rounded-xl text-xs shadow-lg shadow-red-900/30 hover:opacity-95 active:scale-98 transition"
          >
            이해했습니다
          </button>
        </div>
